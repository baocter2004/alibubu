...
return [
    ...
    'checkout' => [
        ...
        'new_address' => 'Enter another address',
    ...
    'compare' => [
        ...
        'breadcrumb' => 'Compare',
        'subtitle' => 'Comparing :count products from the same category',
        'add' => 'Compare',
        'added' => 'Comparing',
        'remove' => 'Remove',
        'clear' => 'Clear all',
        'view' => 'Compare now',
        'hide' => 'Hide compare bar',
        'show' => 'Show compare bar',
        'bar_title' => 'Compare list',
        'slot_empty' => 'Add another product',
        'empty_title' => 'Nothing to compare yet',
        'empty_description' => 'Add up to :max products from the same category to see the full comparison table.',
        'empty_cta' => 'Browse products',
        'need_more' => 'Add at least 2 products to start comparing.',
        'only_diff' => 'Show differences only',
        'best' => 'Best',
        'in_stock' => ':count left in stock',
        'hint_same_category' => 'Only products in the same category can be compared.',
        'sections' => [
            'pricing' => 'Price & offers',
            'reputation' => 'Ratings & popularity',
        ...
        'messages' => [
            'added' => 'Added to the compare list.',
            'removed' => 'Removed from the compare list.',
