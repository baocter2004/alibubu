...
return [
    ...
    'compare' => [
        ...
        'breadcrumb' => 'So sánh',
        'subtitle' => 'Đang so sánh :count sản phẩm cùng danh mục',
        'add' => 'So sánh',
        'added' => 'Đang so sánh',
        'remove' => 'Bỏ so sánh',
        'clear' => 'Xoá tất cả',
        'view' => 'So sánh ngay',
        'hide' => 'Ẩn thanh so sánh',
        'show' => 'Hiện thanh so sánh',
        'bar_title' => 'Danh sách so sánh',
        'slot_empty' => 'Chọn thêm sản phẩm',
        'empty_title' => 'Chưa có sản phẩm nào để so sánh',
        'empty_description' => 'Thêm tối đa :max sản phẩm cùng danh mục để xem bảng so sánh chi tiết.',
        'empty_cta' => 'Khám phá sản phẩm',
        'need_more' => 'Thêm ít nhất 2 sản phẩm để bắt đầu so sánh.',
        'only_diff' => 'Chỉ hiện điểm khác biệt',
        'best' => 'Tốt nhất',
        'in_stock' => 'Còn :count sản phẩm',
        'hint_same_category' => 'Chỉ so sánh được các sản phẩm cùng danh mục.',
        'sections' => [
            'pricing' => 'Giá & ưu đãi',
            'reputation' => 'Đánh giá & mức độ phổ biến',
        ...
        'messages' => [
            ...
            'cleared' => 'Đã xoá danh sách so sánh.',
    ...
    'messages' => [
        ...
        'action_failed' => 'Không thực hiện được, vui lòng thử lại.',
