...
@section('content')
    <div class="site-blocks-cover" style="background-image: url(/views/shoppers/images/hero_1.jpg);" data-aos="fade">
        <div class="container">
    ...
    @include('client.layouts.common.featured-product', ['somethingProducts' => 3])
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="/views/shoppers/images/blog_1.jpg" alt="Image placeholder"
