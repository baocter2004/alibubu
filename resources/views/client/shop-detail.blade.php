...
@section('content')
    @include('client.layouts.common.breadcrumb', [
        'breadcrumbs' => [['url' => route('shop-detail', 1), 'label' => 'Detail']]
    ])
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="/views/shoppers/images/cloth_1.jpg" alt="Image" class="img-fluid">
                </div>
                <div class="col-md-6">
    ...
    @include('client.layouts.common.featured-product', ['somethingProducts' => 10])
@endsection
