        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 mb-4">
                    <span
                        class="w-8 h-8 rounded-lg bg-accent flex items-center justify-center text-accent-foreground font-bold text-sm">A</span>
            ...
            <div>
                <h4 class="text-xs font-semibold uppercase tracking-widest text-white/55 mb-4">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-center gap-2.5 text-sm text-white/60">
                        <i class="fa-solid fa-phone shrink-0 text-accent"></i>
                        {{ __('client.footer.hotline') }}
                    </li>
                    <li class="flex items-center gap-2.5 text-sm text-white/60">
                        <i class="fa-solid fa-envelope shrink-0 text-accent"></i>
