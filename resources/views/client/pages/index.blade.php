...
@section('content')
    ...
    <section
        class="md:hidden rounded-[30px_0_30px_0] overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50 border border-border mb-6">
        <div class="max-w-7xl mx-auto px-4 py-6 flex flex-col items-center text-center gap-4">
            <div class="flex items-center justify-center">
                <h2 class="text-2xl font-bold text-foreground">
                    Uu đãi đặc biệt<br>
                    <span class="text-primary">Chỉ có trên app</span>
                </h2>
            </div>
            <div class="border-b-2 border-t-2 border-blue-900 py-1">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        @foreach ([['fa-solid fa-store', '10.000+', 'Sản phẩm'], ['fa-solid fa-users', '50.000+', 'Khách hàng'], ['fa-solid fa-star', '4.9/5', 'Đánh giá'], ['fa-solid fa-truck', '24h', 'Giao hàng']] as $stat)
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
            @foreach ([['fa-solid fa-shirt', 'Thời trang', '#'], ['fa-solid fa-mobile-screen', 'Điện tử', '#'], ['fa-solid fa-house', 'Nhà cửa', '#'], ['fa-solid fa-wand-sparkles', 'Làm đẹp', '#'], ['fa-solid fa-book', 'Sách', '#'], ['fa-solid fa-gamepad', 'Gaming', '#']] as $cat)
                <a href="{{ $cat[2] }}"
                    ...
                    <i
                        class="{{ $cat[0] }} text-2xl text-muted-foreground group-hover:text-primary group-hover:scale-110 transition-all"></i>
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            @foreach ([['Áo thun basic unisex', '199.000đ', '299.000đ', '33', '4.8', '120'], ['Quần jean slim fit', '450.000đ', '650.000đ', '31', '4.7', '89'], ['Giày sneaker trắng', '599.000đ', '850.000đ', '30', '4.9', '234'], ['Túi tote vải canvas', '250.000đ', '350.000đ', '29', '4.6', '67']] as $p)
                <div
                    class="bg-card border border-border rounded-xl overflow-hidden group hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                    <div class="relative aspect-square bg-muted overflow-hidden">
                        ...
                        <span
                            class="absolute top-2 left-2 px-2 py-0.5 text-[11px] font-bold bg-red-500 text-white rounded-full">-{{ $p[3] }}%</span>
                        <button
                            class="absolute top-2 right-2 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow opacity-0 group-hover:opacity-100 transition-opacity hover:text-primary">
                    ...
                    <div class="p-3">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-1">
                                ...
                                <span class="text-xs text-muted-foreground">{{ $p[4] }}
                                    ({{ $p[5] }})
                                </span>
                            </div>
                            <button
                                class="w-7 h-7 bg-primary rounded-lg flex items-center justify-center hover:bg-primary/80 transition-colors">
